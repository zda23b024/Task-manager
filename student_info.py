...
# Mock student data (like a small database)
students = [
    {'roll_number': 'ZDA23001', 'name': 'Aisha Mohammed', 'course': 'DSAI', 'year': '3rd Year', 'gpa': 7.7},
    ...
    {'roll_number': 'ZDA23004', 'name': 'Hassan Juma', 'course': 'DSAI', 'year': '3rd Year', 'gpa': 6.6},
    {'roll_number': 'ZDA23005', 'name': 'Maryam Yusuf', 'course': 'DSAI', 'year': '3rd Year', 'gpa': 9.8},
]
...
def get_student():
    ...
    if not roll:
        return jsonify({'error': 'Please provide a roll_number parameter'}), 400
